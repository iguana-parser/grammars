...
layout Layout = WhiteSpaceOrComment* !>> [\ \t \f \r \n] !>> "/*" !>> "//";
...
token Tag = "@NoLayout" | "@Layout" | "@Start";
...
start syntax Definition = @scope="NontName" Rule+;
...
syntax ReturnExpression = ReturnExpression: "{" Expression "}";
...
public void main() {
	save(#Definition,"/Users/afroozeh/iggy");
}